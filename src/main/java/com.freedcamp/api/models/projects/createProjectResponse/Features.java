...
public class Features {
	...
	@JsonProperty("f_copy_tasks")
	private boolean fCopyTasks;

	@JsonProperty("f_onedrive_installed")
	private boolean fOnedriveInstalled;

	@JsonProperty("f_gantt_allowed")
	private boolean fGanttAllowed;

	@JsonProperty("f_offline_edit")
	private boolean fOfflineEdit;

	@JsonProperty("f_subtasks_adv_installed")
	private boolean fSubtasksAdvInstalled;

	@JsonProperty("f_table_view_allowed")
	private boolean fTableViewAllowed;

	@JsonProperty("f_onedrive")
	private boolean fOnedrive;

	@JsonProperty("f_shift_dates")
	private boolean fShiftDates;
	...
	@JsonProperty("f_subtasks_adv")
	private boolean fSubtasksAdv;
	...
	@JsonProperty("f_gantt_installed")
	private boolean fGanttInstalled;
